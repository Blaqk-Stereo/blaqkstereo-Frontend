...
import WalletdownwardProgression from "./screens/WalletdownwardProgression";
import WalletTopUpSuccessful from "./screens/WalletTopUpSuccessful";
import WalletTopUpFailed from "./screens/WalletTopUpFailed";
import WalletTopUpProcessing from "./screens/WalletTopUpProcessing";
...
import BankWithdrawalSuccessful from "./screens/BankWithdrawalSuccessful";
import WithdrawalToWalletSuccessfu from "./screens/WithdrawalToWalletSuccessfu";
import ProfileAvatars from "./components/ProfileAvatars";
import Group11 from "./screens/Group11";
import Profile from "./screens/Profile";
import AddSocial from "./screens/AddSocial";
      ...
      <NavigationContainer>
        {hideSplashScreen ? (
          <Stack.Navigator screenOptions={{ headerShown: false }}>
            ...
            />
            <Stack.Screen
              name="WalletdownwardProgression"
              component={WalletdownwardProgression}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="WalletTopUpSuccessful"
              component={WalletTopUpSuccessful}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="WalletTopUpFailed"
              component={WalletTopUpFailed}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="WalletTopUpProcessing"
              component={WalletTopUpProcessing}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="WalletinNGN"
            ...
            />
            <Stack.Screen
              name="BankWithdrawalSuccessful"
              component={BankWithdrawalSuccessful}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="WithdrawalToWalletSuccessfu"
              component={WithdrawalToWalletSuccessfu}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="Group11"
