...
const TopUpWalletlinkCopied = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={styles.topUpWalletlinkCopied}>
          ...
          <View style={styles.modal2}>
            <View style={styles.inputBidParent}>
              <View style={styles.inputBid}>
                ...
                <View style={[styles.copySuccessParent, styles.textPosition]}>
                  <Image
                    style={styles.copySuccessIcon}
                    contentFit="cover"
                    source={require("../assets/copysuccess.png")}
                  />
                  <Text style={[styles.enterYourPlaylist2, styles.textTypo]}>
                    Copied
                  </Text>
                </View>
              </View>
...
export default TopUpWalletlinkCopied;