...
const WalletdownwardProgression = () => {
  ...
  return (
    <>
      <View style={styles.walletdownwardProgression}>
        <View style={[styles.card, styles.cardPosition]}>
          ...
          <View style={[styles.textCurrentWallet, styles.group1052Position]}>
            <View style={styles.nairaParent}>
              <Image
                style={[styles.nairaIcon, styles.nairaIconLayout]}
                contentFit="cover"
                source={require("../assets/naira1.png")}
              />
              <Text style={[styles.currentBalance, styles.textTypo]}>
                Available Balance
              </Text>
            </View>
            <Text style={[styles.blc, styles.blcTypo]}>200.06 NGN</Text>
        ...
        <View style={styles.frameParent}>
          <View style={[styles.activityParent, styles.iconsFlexBox]}>
            ...
            <Pressable style={styles.nairaParent} onPress={openFrameContainer2}>
          ...
          <View style={styles.cardGroup}>
            <View style={styles.cardLayout}>
              ...
              <View style={[styles.group1052, styles.iconsFlexBox]}>
                ...
                <View style={styles.blcParent}>
                  <Text style={[styles.blc1, styles.blcTypo1]}>+₦12,034</Text>
                  <Text style={styles.minutesAgo}>$0.08</Text>
                </View>
              </View>
            </View>
            ...
            <View style={[styles.card4, styles.cardLayout]}>
              ...
              <View style={[styles.group1052, styles.iconsFlexBox]}>
                ...
                <View style={styles.blcContainer}>
                  <Text style={[styles.blc3, styles.blcTypo1]}>-₦1,800</Text>
                  <Text style={styles.minutesAgo}>$0.08</Text>
                </View>
              </View>
            </View>
      ...
      <Modal animationType="fade" transparent visible={infoCircleIconVisible}>
        <View style={styles.infoCircleIconOverlay}>
          ...
          />
          <WalletInfo1 onClose={closeInfoCircleIcon} />
        </View>
      </Modal>
    </>
  );
...
export default WalletdownwardProgression;
