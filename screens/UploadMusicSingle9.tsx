  ...
  return (
    <View style={[styles.uploadMusicsingle, styles.iconLayout]}>
      <Pressable
        ...
        onPress={() => navigation.navigate("PreviewYourAlbumDetails")}
      >
      ...
      <View style={styles.headerPosition}>
        ...
        <Text style={[styles.yourAlbumIs, styles.yourAlbumIsFlexBox]}>
          Your Album Is Uploaded!
        </Text>
        <Text style={[styles.chooseARelease, styles.yourAlbumIsFlexBox]}>
...
export default UploadMusicSingle9;