...
const NewUserStreamingPlatformsS1 = () => {
        ...
        <View style={styles.frameGroup}>
          ...
          <View style={styles.groupParent}>
            <Image
              style={styles.frameChild}
              contentFit="cover"
              source={require("../assets/group-3592351.png")}
            />
            <Text style={[styles.amazonMusic, styles.musicSpaceBlock]}>
              Spotify
            </Text>
          ...
          <View style={styles.groupParent1}>
            <Image
              style={styles.frameChild}
              contentFit="cover"
              source={require("../assets/group-3592361.png")}
            />
            <Text style={[styles.amazonMusic, styles.musicSpaceBlock]}>
              {" "}
              SoundCloud
      ...
      <View style={styles.groupChildPosition}>
        ...
        <View style={[styles.groupParent7, styles.buttonPosition]}>
          <Image
            ...
            contentFit="cover"
            source={require("../assets/group-359243.png")}
          />
          <Image
            style={[styles.frameChild7, styles.frameChildLayout]}
            contentFit="cover"
            source={require("../assets/group-359244.png")}
          />
          <Image
            style={[styles.frameChild7, styles.frameChildLayout]}
            contentFit="cover"
            source={require("../assets/group-359245.png")}
          />
          <View style={[styles.frameChild7, styles.frameChildLayout]}>
            ...
            <Image
              ...
              contentFit="cover"
              source={require("../assets/simpleiconsapplemusic1.png")}
            />
            <Image
...
export default NewUserStreamingPlatformsS1;