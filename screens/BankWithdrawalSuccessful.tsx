...
const BankWithdrawalSuccessful = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={[styles.bankWithdrawalSuccessful, styles.lineIconLayout]}>
            ...
            <View style={[styles.owner, styles.ownerLayout]}>
              ...
              <View style={[styles.authorParent, styles.parentFlexBox]}>
                ...
                <View style={styles.author}>
                  ...
                  <Text style={styles.blc}>Jane Doe</Text>
                </View>
              </View>
            </View>
          </View>
...
export default BankWithdrawalSuccessful;
