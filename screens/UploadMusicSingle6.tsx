...
const UploadMusicSingle6 = () => {
  const [inputFieldContainerVisible, setInputFieldContainerVisible] =
    useState(false);
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  const openInputFieldContainer = useCallback(() => {
    setInputFieldContainerVisible(true);
  }, []);

  const closeInputFieldContainer = useCallback(() => {
    setInputFieldContainerVisible(false);
  }, []);
    ...
    <>
      <View style={styles.uploadMusicsingle}>
        <Pressable
          ...
          onPress={() => navigation.navigate("UploadMusicSingle8")}
        >
        ...
        <View style={styles.frameParent}>
          <View>
            <Pressable
              ...
              onPress={openInputFieldContainer}
            >
              <View
                style={[styles.inputFieldChild, styles.inputFieldChildBg]}
              />
        ...
        <View style={styles.headerPosition}>
          ...
          <View style={[styles.stepGroupHorizontal, styles.inputFieldChildBg]}>
            <View
              style={[
                styles.stepGroupHorizontalChild,
                styles.stepGroupPosition,
              ]}
            />
            <View
            ...
            <View style={styles.complete1}>
              ...
              <Text style={[styles.stepTitle, styles.stepTypo]}>
                Basic Info
              </Text>
            </View>
      ...
      <Modal
        animationType="fade"
        transparent
        visible={inputFieldContainerVisible}
      >
        <View style={styles.inputFieldContainerOverlay}>
          <Pressable
            style={styles.inputFieldContainerBg}
            onPress={closeInputFieldContainer}
          />
          <RolesDropdown onClose={closeInputFieldContainer} />
        </View>
      </Modal>
    </>
  );
...
const styles = StyleSheet.create({
  ...
  inputFieldContainerOverlay: {
    flex: 1,
    alignItems: "center",
    justifyContent: "center",
    backgroundColor: "rgba(113, 113, 113, 0.3)",
  },
  inputFieldContainerBg: {
    position: "absolute",
    width: "100%",
    height: "100%",
    left: 0,
...
export default UploadMusicSingle6;
