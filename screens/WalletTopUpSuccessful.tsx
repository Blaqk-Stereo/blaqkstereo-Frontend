...
const WalletTopUpSuccessful = () => {
  const navigation = useNavigation<StackNavigationProp<ParamListBase>>();

  return (
    <View style={[styles.walletTopUpSuccessful, styles.lineIconLayout]}>
      <View style={styles.successfulPayment1Parent}>
        ...
        <View style={styles.frameParent}>
          <View style={styles.topUpSuccessfulParent}>
            <Text style={styles.topUpSuccessful}>Top Up Successful!</Text>
            <Text style={[styles.yourFundsHave, styles.ownerLayout]}>
              Your funds have been successfully added to your wallet. You can
              now use your balance for subscriptions, promotions, and more.
            </Text>
            <View style={[styles.owner, styles.ownerLayout]}>
              ...
              <View style={[styles.authorParent, styles.parentFlexBox]}>
                ...
                <View style={styles.author}>
                  ...
                  <Text style={styles.blc}>Wallet ID</Text>
                </View>
              </View>
            </View>
          </View>
...
export default WalletTopUpSuccessful;
