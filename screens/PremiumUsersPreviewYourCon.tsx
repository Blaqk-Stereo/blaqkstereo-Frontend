...
const PremiumUsersPreviewYourCon = () => {
  ...
  return (
    <>
      <View style={[styles.premiumUserspreviewYourCon, styles.icon1Layout]}>
        ...
        <View style={styles.frameGroup}>
          <Pressable
            style={[styles.proceedToPayWrapper, styles.wrapperFlexBox]}
            onPress={openFrameContainer8}
          >
            <Text style={[styles.proceedToPay, styles.goBackFlexBox]}>
              Proceed To Pay
            </Text>
          </Pressable>
          <Pressable
          ...
          >
            <Text
              style={[styles.goBack, styles.goBackFlexBox]}
            >{`Go back & Edit`}</Text>
          </Pressable>
        </View>
      ...
      <Modal animationType="fade" transparent visible={frameContainer8Visible}>
        <View style={styles.frameContainer8Overlay}>
          ...
          />
          <CompleteYourPaymentToFinal onClose={closeFrameContainer8} />
        </View>
      </Modal>
    </>
  );
...
export default PremiumUsersPreviewYourCon;
