        ...
        <View style={styles.group2Parent}>
          <View style={styles.group2Parent}>
            ...
            <Text style={[styles.oreYouMit, styles.oreYouMitSpaceBlock]}>
              Your album has been successfully uploaded and will be distributed
...
`}</Text>
            ...
            <View style={styles.titleParent}>
              <Text style={styles.title}>Of Lagos</Text>
              <Text style={styles.title1}>Janey June</Text>
            </View>
          </View>
        </View>
        <Pressable
          style={[styles.viewAlbumWrapper, styles.buttonFlexBox]}
          onPress={() => navigation.navigate("Discover")}
        >
          <Text style={[styles.viewAlbum, styles.shareTypo]}>View album</Text>
        </Pressable>
