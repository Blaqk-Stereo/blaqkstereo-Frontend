...
export type TransactionDetailsINType = {
  onClose?: () => void;
};

const TransactionDetailsIN = ({ onClose }: TransactionDetailsINType) => {
  return (
      ...
      <View style={[styles.receipt, styles.receiptLayout]}>
        ...
        <View style={[styles.receiptCard, styles.overlayPosition]}>
          <View style={styles.amount}>
            <Text style={[styles.text, styles.textLayout]}>-$0.08</Text>
...
export default TransactionDetailsIN;